...
copyright = \markup {
    ...
    \fill-line {
      ...
      \right-column {
        \line { \vspace #1.5 }
        \line { \with-url #"https://github.com/fzalkow/bierey-beethoven-agnus-dei" {\epsfile #Y #5.0 #"qrcode.eps"} \hspace #0.5 \with-url #"http://creativecommons.org/licenses/by/4.0/" {\epsfile #Y #5.0 #"cc_by.eps"}}
      }
      \hspace #0.5
    }
  }
